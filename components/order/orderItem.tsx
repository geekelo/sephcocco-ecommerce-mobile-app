...
interface OrderItemProps {
  ...
  userId: string;
  outlet: string;
  quantity: number; // ✅ controlled quantity from parent
  onIncrease: () => void;
  onDecrease: () => void;
}
    ...
    updateMutation.mutate(
      {
        id: order.id,
        user_id: userId,
        quantity, // ✅ uses parent-controlled quantity
        outlet,
      },
      {
        onSuccess: () => {
  ...
  return (
    <Animated.View
      ...
      style={[
        ...
        isSelected && { backgroundColor: '#f8f8f8' },
      ]}
    >
      ...
      <View style={styles.orderInfo}>
        ...
        {isEditing ? (
          ...
          <View style={styles.quantityContainer}>
            <Text style={styles.statusText}>Quantity: {quantity}</Text>
          </View>
        )}
        ...
        <View style={styles.priceContainer}>
          ...
          <View style={styles.priceRow}>
            ...
            <Text style={[styles.priceValue, { color: 'red' }]}>₦ {totalPrice}</Text>
          </View>
        </View>
        ...
        <View style={styles.actionButtons}>
          <TouchableOpacity style={styles.editBtn} onPress={handleEditToggle}>
            <Ionicons
              ...
              color="#fff"
            />
            <Text style={styles.actionText}>{isEditing ? 'Update' : 'Edit'}</Text>
          </TouchableOpacity>
